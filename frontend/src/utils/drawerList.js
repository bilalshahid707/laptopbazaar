...
export const drawerList = ()=>{
  ...
  return (
  <form onSubmit={handleSubmit(onSubmit)} className="w-60 bg-blueAccent p-4 rounded-lg shadow-md">
        <div className="mb-4 input-group">
          <label className="text-base font-medium">Sort by Price</label>
          <select className="dropdown text-base" {...register('sort')}>
        ...
        {/* Submit Button */}
        <input type="submit" value="Apply Filters" className="btn-filled w-full"/>
        </form>
  )
}
